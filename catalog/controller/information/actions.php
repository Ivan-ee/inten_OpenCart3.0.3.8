...
class ControllerInformationActions extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($actions as $action) {
            ...
            $action_info['href_to_product'] = $this->url->link('catalog/actions', 'action_id=' . $action_info['id']);

            $action_info['href_to_action'] = $this->url->link('information/action', 'action_id=' . $action_info['id']);
