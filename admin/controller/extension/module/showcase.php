...
class ControllerExtensionModuleShowcase extends Controller {
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $banner_id) {
                $this->model_extension_module_showcase->deleteBanner($banner_id);
            }
    ...
    protected function getList() {
        ...
        $banner_total = $this->model_extension_module_showcase->getTotalBanners();

        $results = $this->model_extension_module_showcase->getBanners($filter_data);
